...
files = {
    "buster/ui/os1/__init__.py": "",

    "buster/ui/os1/main_window.py": r'''from __future__ import annotations
...
''',
    ...
    "run_buster_ai_os.py": r'''import sys
...
''',
    ...
    "tests/test_buster_ai_os_shell_import.py": r'''def test_buster_ai_os_shell_import():
    from buster.ui.os1.main_window import BusterAIOSMainWindow
    assert BusterAIOSMainWindow is not None
'''
}
...
print("Buster Desktop AI OS 1.0 shell added.")