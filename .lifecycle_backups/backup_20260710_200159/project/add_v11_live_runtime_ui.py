...
files = {
    "buster/ui/v11/__init__.py": "",

    "buster/ui/v11/live_runtime_ui.py": r'''from __future__ import annotations
...
''',
    ...
    "test_v11_live_runtime_ui.py": r'''import sys
...
''',
    ...
    "tests/test_v11_live_runtime_ui_imports.py": r'''def test_v11_live_runtime_ui_imports():
    from buster.ui.v11.live_runtime_ui import BusterLiveRuntimeUI
    assert BusterLiveRuntimeUI is not None
''',

    "run_v11_live_runtime_ui.py": r'''import sys
from PySide6.QtWidgets import QApplication
...
print()
print("Buster v11 Live Runtime UI foundation added.")
print()
print("Run:")
print("  python run_v11_live_runtime_ui.py")
print("  pytest")