...
files = {
    "buster/ui/v11/runtime_console.py": r'''from __future__ import annotations
...
''',
    ...
    "run_runtime_console.py": r'''import sys
...
''',
    ...
    "tests/test_runtime_console_import.py": r'''def test_runtime_console_import():
    from buster.ui.v11.runtime_console import RuntimeConsole
    assert RuntimeConsole is not None
'''
}
...
print()
print("Runtime Console UI added.")
print()
print("Run:")
print("  python run_runtime_console.py")
print("  pytest")