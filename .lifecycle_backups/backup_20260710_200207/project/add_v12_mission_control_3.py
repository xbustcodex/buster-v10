...
files = {
    "buster/ui/v12/__init__.py": "",

    "buster/ui/v12/mission_control.py": r'''from __future__ import annotations
...
''',
    ...
    "run_mission_control_v12.py": r'''import sys
...
''',
    ...
    "tests/test_v12_mission_control_import.py": r'''def test_v12_mission_control_import():
    from buster.ui.v12.mission_control import MissionControlV12
    assert MissionControlV12 is not None
'''
}
...
print("Mission Control 3.0 added.")