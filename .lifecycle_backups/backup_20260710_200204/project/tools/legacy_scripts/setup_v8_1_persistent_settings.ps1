...
'@ | Set-Content "buster/core/settings_store.py"
...
'@ | Set-Content "patch_persistent_settings.py"

python patch_persistent_settings.py
Write-Host "Persistent settings setup complete."